# "dentist", Miami, FL, observed 2026-09-20
...
Why this study is in the set: a large metro: the target and the point were drawn from a seed, not chosen.

| figure | value |
|---|---|
| visible | 24/80 measured (30%), 0 unreached and excluded |
| in the top 3 | 24/80 measured (30%) |
| reach edge | 6.2 km (6/6 measured on that ring, needs 3). [fragile] a re-scan could move this edge: the next ring out (9.8 km) is 2/6, 95% interval 0.10-0.70, which contains 0.5 |
| top-3 edge | 6.2 km (6/6 measured on that ring, needs 3). [fragile] a re-scan could move this edge: the next ring out (9.8 km) is 2/6, 95% interval 0.10-0.70, which contains 0.5 |
| gone by | not reportable: sightings resume at 24.2, 38.1 km |
| shape | patchy (inner 6/6 at 2.5 km, middle 0/8 at 15.4 km, outer 0/18 at 60 km). A descriptive label for the curve, not a diagnosis |
...
|---|---|---|---|---|
| home | 1/1 | 1/1 | 0 | only 1 measured point(s); needs 4 to be reportable |
| 2.5 km | 6/6 | 6/6 | 0 |  |
| 3.9 km | 6/6 | 6/6 | 0 |  |
| 6.2 km | 6/6 | 6/6 | 0 |  |
| 9.8 km | 2/6 | 2/6 | 0 |  |
...
- Absent means the business was not in the list captured at that point. Those lists held between 1 and 10 rows.
- Observed: 2026-09-20T04:58:07.183Z. This is a dated observation, not a live claim. The observation window is unknown: the source file records one timestamp for the whole scan, and an 80-point scan is not instantaneous.
- Geometry: preset `mid`, 80 points, 2.5-60 km, 8 rings, 110.57 km per degree of latitude.
- Published centre: 25.81, -80.2, rounded to 2 decimal places. 
...
falloff render studies/2026-09-20-dentist-miami-fl/snapshot.json --out report.html
```
